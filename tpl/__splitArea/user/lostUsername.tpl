		...
		<form id="userRegisterForm" method="POST">
			<fieldset>
				<div class="col col1 break">
					...
					<label for="lostPassword" class="requiredBefore">Password:</label>
					<input type="password" id="lostPassword" name="lostPass" required="required"/>
				</div>

				<dic class="col col1 break userSubmit">
					<input type="submit" class="button" name="lostUsername" value="Benutzername anfordern"/>
				</dic>
			</fieldset>
		</form>
	</div>
