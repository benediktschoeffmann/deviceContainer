...
// http://oe24dev.oe24.at/test/bs/slideshow/Test-Slideshow/161624808
// -------------------------------------------
...
$showAds = $slideshowOptions->get('AditionAdTags') !== 'Keine Werbung laden';
	...
	<div class="sidebar article">
		...
		<? if ($isOe24SlideShow): ?>
			<div class="sidebarContainer">
				...
				/*
				(bs) TODO:
				ich baue hier mal denselben Mechanismus wie bei ArticleDefault ein,
				muss geklärt werden, ob das so sein soll.
				*/
				tpl(
