...
$isOe2016Article = isOe2016Layout($layout, $isArticle);

if ($isOe2016Article && ($isArticle)) {
    $additionalWrapClass = ' a2016';
}

if ($isOe2016Article && ($useNewLayout === 'oe2016')) {
    $additionalWrapClass = $additionalWrapClass . ' oe2016';
}

$useNewCollector = $useNewCollector && ($isOe2016Article);
