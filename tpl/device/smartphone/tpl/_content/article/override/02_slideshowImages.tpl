...
$sliderDescription = '.sliderDescription_'.uniqid();
// debug($sliderDescription);
...
<div class="overrideSlideshow overrideImageSlideshow storySlideshow">
    ...
    <div class="<?= $classSlider; ?>" data-options='<?= $optionsSliderMain; ?>'>
    ...
    <div class="<?= $classSlider; ?> <?= $sliderDescription; ?>" data-options='<?= $optionsSliderDescription; ?>'>
