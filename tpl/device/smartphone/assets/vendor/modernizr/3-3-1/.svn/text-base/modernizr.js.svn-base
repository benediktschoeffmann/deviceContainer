...
/*!
 * modernizr v3.3.1
 * Build http://modernizr.com/download?-audio-cookies-customevent-eventlistener-inlinesvg-input-inputtypes-json-queryselector-search-smil-svg-svgasimg-svgclippaths-svgfilters-svgforeignobject-touchevents-video-websockets-addtest-atrule-domprefixes-hasevent-mq-prefixed-prefixedcss-prefixedcssvalue-prefixes-setclasses-shiv-testallprops-testprop-teststyles-dontmin
 *
 * Copyright (c)
 *  Faruk Ates
 *  Paul Irish
